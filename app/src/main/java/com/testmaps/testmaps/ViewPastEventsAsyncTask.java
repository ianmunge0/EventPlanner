...
//            data += "&password=" + URLEncoder.encode(passWord, "UTF-8");
            ...
            link = "http://192.168.41.1/tukioeventhandlers/viewpastevents.php";// + data; //exact host url
...
//            	vieweventss.setText(query_result1);
                ...
                /*if(query_result.equals("EMPTY VALUES"))
                {
...
//                	vieweventss.setText(result);
                ...
                /*else if (query_result.equals("NOEVENTS"))
                {
                ...
                if(jsonArray != null)
                {
                    ...
                    //editor.putString("prefkey0forviewevents", jsonArray.toString());
                    //editor.commit();
